# Greenhouse-gas source influence at Bukit Kototabang
...
**Table 7. Material uncertainties and consequences.** Numerical checks do not eliminate these scientific uncertainties.
...
The present results are therefore suitable for research screening and prioritizing source datasets, not for regulatory attribution or an operational emission estimate. An inversion would require a series of observations, a flux prior with uncertainties, defensible background concentrations, and a transport-error covariance model. A single selected hour cannot constrain the many spatial and sectoral unknowns independently.
...
The next defensible step is evaluation across multiple receptor hours with independent background concentrations and meteorological observations, alongside ecosystem fluxes and source-height information. That evidence is needed before interpreting source-weighted enhancements as quantitatively validated contributions or using the system for emission inversion.
